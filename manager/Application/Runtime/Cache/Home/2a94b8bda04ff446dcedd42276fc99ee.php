...
<div class="header bg-main">
    <div class="logo margin-big-left fadein-top">
        <h1><img src="/Public/manager/images/y.jpg" class="radius-circle rotate-hover" height="50" alt="" />后台管理中心</h1>
    </div>
    <div class="head-l"><a class="button button-little bg-red" href="/manager/index.php/Home/Login/exitlogin"><span class="icon-power-off"></span> 退出登录</a> </div>
</div>
<div class="leftnav">
    <div class="leftnav-title"><strong><span class="icon-list"></span>菜单列表</strong></div>
    <h2><span class="icon-user"></span>系统设置</h2>
    <ul style="display:block">
        <li><a href="/manager/index.php/Home/Admin/index" target="right"><span class="icon-caret-right"></span>管理员管理</a></li>
        <li><a href="/manager/index.php/Home/User/index" target="right"><span class="icon-caret-right"></span>用户管理</a></li>
    </ul>
    ...
    <h2><span class="icon-pencil-square-o"></span>签到管理</h2>
    <ul>
        <li><a href="add.html" target="right"><span class="icon-caret-right"></span>日常签到</a></li>
        <li><a href="add.html" target="right"><span class="icon-caret-right"></span>活动签到</a></li>
    </ul>
</div>
...
<div class="admin">
    <iframe scrolling="auto" rameborder="0" src="/manager/index.php/Home/Admin/index" name="right" width="100%" height="100%"></iframe>
</div>
